...
const File = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      const response = await sendRequest({
        method: "get",
        url: `/api/appealtorector/getbyidappealtorector/${id}`,
        headers: {
  ...
  const confirm = () => {
    navigate(`/${language}/admin/appeals`);
        ...
        <table border={0} style={{ width: "100%" }}>
          <tbody>
            <tr className="b-o">
              ...
              <td className="b-o">
                <img loading="lazy" src={logo} alt="logo" style={{ height: 60 }} />
                <br />
                <br />
            ...
            <tr className="b-all">
              ...
              <td className="td-l">
                <NavLink target="_blank" to={`${data?.file_?.url}`}>
                  {data?.file_?.title}
                </NavLink>
              </td>
            </tr>
        ...
        <form className="no-print no_dw">
          <div style={{ paddingTop: 30 }}>
            <center>
              ...
              <br />
              <br />
              <NavLink href="#">Yuklab olish</NavLink>
            </center>
          </div>
        </form>
      </section>
