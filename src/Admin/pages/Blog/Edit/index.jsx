...
const Edit = () => {
  ...
  const getData = async (value) => {
    const res = await sendRequest({
      ...
      url:
        value === "uz"
          ? `/api/blogcontroller/getbyidblog/${id}`
          : `/api/blogcontroller/getbyuzidblogtranslation/${id}?language_code=${value}`,
      headers: {
  ...
  const onHandleSubmit = async (e) => {
    ...
    formData.append("event_date", date1 || null);
    formData.append("event_end_date", date2 || null);
    ...
    const res = await useEdit(
      ...
      transId,
      formData,
      "/api/blogcontroller/updateblog",
      "/api/blogcontroller/updateblogtranslation",
      [
        { blog_id: id },
        { language_id },
        { status_translation_id: status },
        { blog_category_translation_id: blogValue },
      ],
      ["blog_category_id"],
