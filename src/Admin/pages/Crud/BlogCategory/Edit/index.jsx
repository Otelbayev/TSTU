...
const Edit = () => {
  ...
  const onHandleSubmit = async (e) => {
    ...
    const res = await useEdit(
      ...
      "/api/blogcategorycontroller/updateblogcategory",
      "/api/blogcategorycontroller/updateblogcategorytranslation",
      [
        { language_id },
      ...
      ["status_id"],
      "/api/blogcategorycontroller/createblogcategorytranslation",
  ...
  useEffect(() => {
    ...
    getDataById(
      value === "uz"
        ? `/api/blogcategorycontroller/getbyidblogcategory/${id}`
        : `/api/blogcategorycontroller/getbyuzidblogcategorytranslation/${id}?language_code=${value}`
    );
  }, [value, isCreate]);
