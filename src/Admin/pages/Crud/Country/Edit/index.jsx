...
const Edit = () => {
  ...
  const onHandleSubmit = async (e) => {
    ...
    const res = await useEdit(
      ...
      "/api/country/updatecountrytranslation",
      [{ language_id }, { status_translation_id: status }, { country_id: id }],
      ["status_id"],
      "/api/country/createcountrytranslation",
  ...
  useEffect(() => {
    getDataById(
      value === "uz"
        ? `/api/country/getbyidcountry/${id}`
        : `/api/country/getbyuzidcountrytranslation/${id}?language_code=${value}`
    );
    getStatus(value);
  }, [value, isCreate]);
