...
const Create = () => {
  ...
  const onHandleSubmit = async (e) => {
    ...
    const res = await useEdit(
      ...
      "/api/departamentDetaildetail/updatedepartamentDetail",
      "/api/departamentDetaildetail/updatedepartamentDetailtranslation",
      [
        { language_id },
      ...
      "/api/departamentDetaildetail/createdepartamentDetailtranslation",
      [
        { language_id },
        { departament_translation_id: department },
        { departament_detail_id: id },
  ...
  async function getData(value, id) {
    const res = await axios.get(
      value === "uz"
        ? `/api/departamentDetaildetail/getbyiddepartamentDetail/${id}`
        : `/api/departamentDetaildetail/getbyuziddepartamentDetailtranslation/${id}?language_code=${value}`,
      {
        headers: {
