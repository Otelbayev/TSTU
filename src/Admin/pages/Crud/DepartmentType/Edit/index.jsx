...
const Edit = () => {
  ...
  const onHandleSubmit = async (e) => {
    ...
    const res = await useEdit(
      ...
      "/api/deartamenttypecontroller/updatedepartamentType",
      "/api/deartamenttypecontroller/updatedepartamentTypetranslation",
      [
        { language_id },
      ...
      ["status_id"],
      "/api/deartamenttypecontroller/createdepartamentTypetranslation",
  ...
  useEffect(() => {
    getDataById(
      value === "uz"
        ? `/api/deartamenttypecontroller/getbyiddepartamentType/${id}`
        : `/api/deartamenttypecontroller/getbyuziddepartamentTypetranslation/${id}?language_code=${value}`
    );
    getStatus(value);
  }, [value, isCreate]);
