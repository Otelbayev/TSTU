...
const Edit = () => {
  ...
  const onHandleSubmit = async (e) => {
    ...
    const res = await useEdit(
      ...
      "/api/employment/updateemployment",
      "/api/employment/updateemploymenttranslation",
      [
        { language_id },
      ...
      ["status_id"],
      "/api/employment/createemploymenttranslation",
  ...
  useEffect(() => {
    getDataById(
      value === "uz"
        ? `/api/employment/getbyidemployment/${id}`
        : `/api/employment/getbyuzidemploymenttranslation/${id}?language_code=${value}`
    );
    getStatus(value);
  }, [value, isCreate]);
