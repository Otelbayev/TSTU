...
const Edit = () => {
  ...
  const onHandleSubmit = async (e) => {
    ...
    const res = await useEdit(
      ...
      "/api/gender/updategender",
      "/api/gender/updategendertranslation",
      [{ status_translation_id: status }, { language_id }, { gender_id: id }],
      ["status_id"],
      "/api/gender/creategendertranslation",
  ...
  useEffect(() => {
    ...
    getDataById(
      value === "uz"
        ? `/api/gender/getbyidgender/${id}`
        : `/api/gender/getbyuzidgendertranslation/${id}?language_code=${value}`
    );
  }, [value, isCreate]);
