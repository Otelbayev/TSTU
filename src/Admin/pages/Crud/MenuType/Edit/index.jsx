...
const Edit = () => {
  ...
  const onHandleSubmit = async (e) => {
    ...
    const res = await useEdit(
      ...
      "/api/menutype/updatemenutype",
      "/api/menutype/updatemenutypetranslation",
      [
        { language_id },
      ...
      ["status_id"],
      "/api/menutype/createmenutypetranslation",
  ...
  useEffect(() => {
    getDataById(
      value === "uz"
        ? `/api/menutype/getbyidmenutype/${id}`
        : `/api/menutype/getbyuzidmenutypetranslation/${id}?language_code=${value}`
    );
    getStatus(value);
  }, [value, isCreate]);
