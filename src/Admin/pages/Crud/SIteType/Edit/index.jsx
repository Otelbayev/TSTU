...
const Edit = () => {
  ...
  const onHandleSubmit = async (e) => {
    ...
    const res = await useEdit(
      ...
      "/api/sitetype/updatesitetype",
      "/api/sitetype/updatesitetypetranslation",
      [{ language_id }, { status_translation_id: status }],
      ["status_id"],
      "/api/sitetype/createsitetypetranslation",
  ...
  useEffect(() => {
    ...
    getDataById(
      value === "uz"
        ? `/api/sitetype/getbyidsitetype/${id}`
        : `/api/sitetype/getbyuzidsitetypetranslation/${id}?language_code=${value}`
    );
  }, [value, isCreate]);
