...
const Edit = () => {
  ...
  const handleChange = async (e) => {
    ...
    const res = await useEdit(
      ...
      transId,
      formData,
      "/api/sitedetail/updatesitedetail",
      "/api/sitedetail/updatesitedetailtranslation",
      [
        { site_detail_id: id },
        { language_id },
      ...
      ["site_id", "status_id"],
      "/api/sitedetail/createsitedetailtranslation",
      [
        { language_id },
        { site_detail_id: id },
        { site_translation_id: siteId },
  ...
  const getData = async (value, id) => {
    const res = await axios.get(
      value === "uz"
        ? `/api/sitedetail/getbyidsitedetail/${id}`
        : `/api/sitedetail/getbyuzidsitedetailtranslation/${id}?language_code=${value}`,
      {
        headers: {
