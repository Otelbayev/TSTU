...
const Edit = () => {
  ...
  const onHandleSubmit = async (e) => {
    ...
    const res = await useEdit(
      ...
      "/api/usertype/updateusertype",
      "/api/usertype/updateusertypetranslation",
      [
        { language_id },
      ...
      ["status_id"],
      "/api/usertype/createusertypetranslation",
  ...
  useEffect(() => {
    getDataById(
      value === "uz"
        ? `/api/usertype/getbyidusertype/${id}`
        : `/api/usertype/getbyuzidusertypetranslation/${id}?language_code=${value}`
    );
    getStatus(value);
  }, [value, isCreate]);
