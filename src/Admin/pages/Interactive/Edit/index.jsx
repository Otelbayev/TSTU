...
const Edit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await useEdit(
      ...
      transId,
      formData,
      "/api/interactiveservices/updateinteractiveservices",
      "/api/interactiveservices/updateinteractiveservicestranslation",
      [
  ...
  const getDataId = async (value, id) => {
    const res = await axios.get(
      value === "uz"
        ? `/api/interactiveservices/getbyidinteractiveservices/${id}`
        : `/api/interactiveservices/getbyuzidinteractiveservicestranslation/${id}?language_code=${value}`,
      {
        headers: {
