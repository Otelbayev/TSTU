...
const Form = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("/api/appealtorector/createappealtorector", {
        method: "POST",
        headers: {
          ...headers,
        },
  ...
  const getCountry = async () => {
    try {
      const response = await sendRequest({
        method: "get",
        url: "/api/country/sitegetallcountry",
      });
  ...
  const getGender = async () => {
    try {
      const response = await sendRequest({
        method: "get",
        url: "/api/gender/sitegetallgender",
      });
  ...
  const getEmployment = async () => {
    try {
      const response = await sendRequest({
        method: "get",
        url: "/api/employment/sitegetallemployment",
      });
  ...
  const onCountryChange = async (value) => {
    ...
    try {
      const response = await sendRequest({
        method: "get",
        url: `/api/territorie/sitegetallterritorie?country_id=${value}`,
      });
  ...
  const onTerretoryChange = async (value) => {
    ...
    try {
      const response = await sendRequest({
        method: "get",
        url: `/api/district/sitegetalldistrict?territorie_id=${value}`,
      });
  ...
  const onDistrictChange = async (value) => {
    ...
    try {
      const response = await sendRequest({
        method: "get",
        url: `/api/neighborhood/sitegetallneighborhood?district_id=${value}`,
      });
  ...
  const getCapchaNums = async () => {
    try {
      const response = await sendRequest({
        method: "get",
        url: "/api/captcha/getcaptchanumbers",
        headers,
      });
